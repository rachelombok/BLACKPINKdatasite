...
import icecreampic from '../extra/images/icecream2.JPG'
...
class Tunefind extends React.Component{
    render(){
      return(
        <div>
            <Jumbotron fluid className='jumbotron-tunefind'>
              
  <Container className='tint' fluid>
    <br/><br/><br/><br/>
    <h1 className='titlefont'>Tunefind</h1>
    <p>
